package org.lemon.commons.idempotent.aspectj;
...
import org.lemon.commons.core.utils.MessageUtils;
...
public class RepeatSubmitAspect {
    ...
    public void doBefore(JoinPoint point, RepeatSubmit repeatSubmit) {
        ...
        // 唯一值（没有消息头则使用请求地址）
        String submitKey = AuthenticationUtil.resolveAuthorization(request, properties.getTokenHeader(), properties.getTokenParameter());
