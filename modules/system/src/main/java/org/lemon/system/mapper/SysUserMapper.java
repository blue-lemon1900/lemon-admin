...
import org.lemon.commons.mybatis.annotation.DataColumn;
...
public interface SysUserMapper extends BaseMapperPlus<SysUser, SysUserVo> {
     ...
     * @return 用户基本信息
     */
    SysUser loadUserByTenantIdAndUsername(@Param("tenantId") String tenantId, @Param("username") String username);
