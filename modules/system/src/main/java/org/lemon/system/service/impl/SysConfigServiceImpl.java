...
import org.lemon.system.domain.entity.SysConfig;
import org.lemon.system.domain.vo.SysConfigVo;
import org.lemon.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService, ConfigService {
    ...
    public void deleteConfigByIds(List<Long> configIds) {
        ...
        list.forEach(config -> {
            if (Strings.CS.equals(SystemConstants.YES, config.getConfigType())) {
